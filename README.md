# BIOS6624-Class
This repository is for all project work for BIOS6624-Advanced Statistical Methods and Analysis. Each project will be contained and structured in the same manner. Note, that data in the DataRaw and DataProcessed folders are ignored. They are meant only for the analyst and prevents data sharing prior to final release with publication.
...
| `DataProcessed` | contains the processed data used for analysis (analyst only) |
