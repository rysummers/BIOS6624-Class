...
fit_dcd4  <- lm(d_cd4 ~ hard0 + age0 + bmi0 + factor(smoke0) + factor(educ0) +
                  factor(race0), 
                data=ana)

fit_dphys <- lm(d_phys ~ hard0 + age0 + bmi0 + factor(smoke0) + factor(educ0) + 
                  factor(race0), 
                data=ana)

fit_dment <- lm(d_ment ~ hard0 + age0 + bmi0 + factor(smoke0) + factor(educ0) +
                  factor(race0), 
                data=ana)
